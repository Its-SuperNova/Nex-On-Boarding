...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <form
      className={cn(
        "w-full relative mx-auto bg-gray-100 dark:bg-zinc-900 transition duration-200",
        value && "bg-gray-200",
        multiline
          ...
          : "rounded-full h-[50px] shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)]",
      )}
    ...
    >
      ...
      <InputComponent
        ...
        maxLength={maxLength}
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border-none dark:text-white bg-transparent text-black focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-20",
          animating && "text-transparent dark:text-transparent",
          multiline ? "rounded-xl h-40 py-4 resize-none pb-8" : "rounded-full h-[50px]",
        )}
      />
      ...
      {value && (
        <button
          type="submit"
          className={cn(
            "absolute right-2 z-50 px-4 rounded-full bg-[#121214] border border-gray-600 transition duration-200 flex items-center justify-center text-xs text-gray-300",
